...
// 演示账号
const demoAccounts = [
  { username: 'admin', password: '123456', type: 'danger', role: '系统管理员' },
  { username: 'zhangsan', password: '123456', type: 'warning', role: '部门主管' },
  { username: 'lisi', password: '123456', type: 'primary', role: '部门主管' },
  { username: 'emp001', password: '123456', type: 'success', role: '普通员工' }
]
  ...
  await formRef.value.validate(async (valid) => {
    ...
    try {
      ...
      if (res.code === 0) {
        ...
        ElMessage.success(`欢迎回来，${userInfo.name}！[${roleNameMap[userInfo.role] || '员工'}]`)
