...
import { hasPermission, PERMISSIONS, getUserInfo, getUserRole, ROLE_NAME_MAP } from '@/utils/permission'
...
const menuList = computed(() => {
  ...
  console.log('角色名称:', ROLE_NAME_MAP[role] || '未知')
...
onMounted(() => {
  ...
  if (info) {
    ...
    console.log('角色名称:', ROLE_NAME_MAP[info.role] || '未知')
    console.log('部门ID:', info.departmentId)
    console.log('===============================')
  }
})
</script>
