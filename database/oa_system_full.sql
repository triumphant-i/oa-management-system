...
-- 2. 员工数据（密码均为 123456 的 BCrypt 加密值）
INSERT INTO `t_employee` (`username`, `password`, `name`, `gender`, `phone`, `email`, `department_id`, `position`, `status`, `role`, `join_date`) VALUES
('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '系统管理员', '男', '13800000000', 'admin@oa.com', 1, '系统管理员', '在职', 'SYSTEM_ADMIN', '2026-01-01'),
('zhangsan', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '张三', '男', '13800138001', 'zhangsan@oa.com', 1, '技术总监', '在职', 'DEPARTMENT_MANAGER', '2026-01-01'),
('lisi', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '李四', '女', '13800138002', 'lisi@oa.com', 2, '产品总监', '在职', 'DEPARTMENT_MANAGER', '2026-01-01'),
('wangwu', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '王五', '男', '13800138003', 'wangwu@oa.com', 3, '运营总监', '在职', 'EMPLOYEE', '2026-01-01'),
('zhaoliu', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '赵六', '女', '13800138004', 'zhaoliu@oa.com', 4, '人事主管', '在职', 'EMPLOYEE', '2026-01-01'),
('qianqi', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '钱七', '男', '13800138005', 'qianqi@oa.com', 5, '财务主管', '在职', 'EMPLOYEE', '2026-01-01'),
('emp001', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '员工一', '男', '13800138011', 'emp001@oa.com', 1, 'Java开发工程师', '在职', 'EMPLOYEE', '2026-03-01'),
('emp002', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '员工二', '女', '13800138012', 'emp002@oa.com', 1, '前端开发工程师', '在职', 'EMPLOYEE', '2026-03-01'),
('emp003', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '员工三', '男', '13800138013', 'emp003@oa.com', 2, '产品经理', '在职', 'EMPLOYEE', '2026-03-01'),
('emp004', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', '员工四', '女', '13800138014', 'emp004@oa.com', 3, '运营专员', '在职', 'EMPLOYEE', '2026-03-01');
...
('项目启动会', 1, '第一会议室', 7, '员工一', '员工一,员工二,员工三', '2026-07-21 09:00:00', '2026-07-21 11:00:00', '已预约', '新项目启动'),
('部门周例会', 2, '第二会议室', 2, '张三', '技术部全体', '2026-07-22 14:00:00', '2026-07-22 16:00:00', '已预约', '周例会');
